...
import { RBIVerifiedBankList } from "../Helper/FundProviderListHelper";
  ...
  async function bankSigupVerification(userDetails) {
    ...
    try {
      ...
      if(data[bankUserName]) {
        setErrorConfig({
          isError: true,
          errorMessage: "An Account for this bank already exists"
        })
      }
      else {
  ...
  return (
    <Card className={classes.card}>
      ...
      <div className={styles.input}>
        ...
        >
          <label htmlFor="firmname">Bank Name</label>
          <Multiselect
            id="css_custom"
          ...
          <label htmlFor="firmphone">Bank Phone Number</label>
